...
const CreateRecipePage: React.FunctionComponent = () => {
    ...
    const [init_vals, setInitVals] = useState({
        cuisines: [{ name: '' }],
        diets: [{ name: '' }],
        ingredients: [{ name: '', units: '', quantity: 1 }],
        overall_prep_time: 1,
        overall_cooking_time: 1,
        instructions: [
            {
                instruction: '',
                prep_time: 1,
    ...
    return (
        <ProtectedRoute>
            <PageLayout title="Create a Recipe" maxWidth={'xl'}>
                <Box
                    sx={{
                        marginTop: 8,
                        display: 'flex',
